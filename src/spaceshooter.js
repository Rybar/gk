...
const { Container, CanvasRenderer, Text, Texture, Sprite, KeyControls, math, TileSprite, Game }  = gt;
...
const textures = {
    ...
    squizz: new Texture('./res/img/squizz-Sheet.png')
}
